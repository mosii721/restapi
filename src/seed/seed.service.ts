...
import { Adminprofile, Role } from 'src/adminprofiles/entities/adminprofile.entity';
...
export class SeedService {
    ...
    async seed(){
      ...
      for (let i = 0; i < 5; i++) {
        ...
        const savedAdminProfile = await this.adminProfileRepository.save(adminProfile);
